...
pub struct GestureState {
    ...
    /// Captured at begin so a gesture cannot migrate to another workspace or
    /// become eligible after beginning outside Scrolling mode.
    pub scrolling_pan_target: Option<ScrollingPanTarget>,
    pub delta: f64,
